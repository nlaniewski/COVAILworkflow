...
manifest.batched$manifest.collapsed[batch.seq=="001"]
stage.boxes<-COVAILworkflow::plot_manifest.stage(manifest.batched$manifest.collapsed)
...
manifest_batched<-data.table::setDT(
  openxlsx::read.xlsx(
    manifest.batched.path,sheet="manifest_collapsed"
  )
)

##representative example: "COVAIL_001"; create a workbook
COVAILworkflow::manifest.stage.sheets(
  manifest_batched[stage.name=="COVAIL_001"],
...
data.table::setDT(
  openxlsx::read.xlsx(
    file.path(tempdir(),"COVAIL_001.xlsx")
  )
)[]
